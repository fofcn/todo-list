...
import com.epam.common.socket.util.Updaters;
...
public class NettyConnectionHelper {
    ...
    public static Connection getOrCreateConnection(final ServerStream stream,
        ...
        if (stream instanceof NettyServerStream) {
            NettyServerStream nettyServerStream = (NettyServerStream) stream;
            Channel channel = NettyServerStreamUtil.getChannel(nettyServerStream);
            return attachChannel(channel, listeners);
        }
        return null;
    }
