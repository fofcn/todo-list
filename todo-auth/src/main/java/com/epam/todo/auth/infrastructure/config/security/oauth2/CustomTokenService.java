...
public class CustomTokenService implements AuthorizationServerTokenServices, ResourceServerTokenServices, ConsumerTokenServices, InitializingBean {
        ...
        if (!this.supportRefreshToken) {
            ...
            if (refreshToken == null) {
                ...
                if (clientId != null && clientId.equals(tokenRequest.getClientId())) {
                    OAuth2AccessToken oldAccessToken = this.tokenStore.getAccessToken(authentication);
                    if (oldAccessToken != null && StringUtils.hasLength(oldAccessToken.getValue())) {
                        oldAccessToken = this.tokenStore.readAccessToken(oldAccessToken.getValue());
                        if (oldAccessToken != null && StringUtils.hasLength(oldAccessToken.getValue())) {
